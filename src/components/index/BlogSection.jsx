...
export default function BlogSection({ posts }) {
  ...
  return (
    <div className="w-[90%] xl:w-full lg:px-16 xl:px-48 xl:py-32 m-auto grid xl:grid-cols-4   lg:bg-gray-100">
        ...
        {posts.slice(0, 3).map((post) => (
          <div
            ...
            <div className="lg:w-1/2 xl:w-2/4  flex flex-col justify-between">
              ...
              <Link
                href={post.uri}
                className="relative overflow-hidden group bg-primary rounded-full text-white  px-11 py-3 w-fit mt-11 flex items-center transition-colors duration-300 ease-out">
                <span className="mr-3 z-30">{paper}</span>{" "}
                <h3 className="z-30 group-hover:tracking-wide duration-300 ">
                  Read The Article
                </h3>
