...
const Menu = () => {
  ...
  return (
    ...
    <div
      className={`w-full absolute top-0 lg:border-b-[1px] pt-5  z-50 text-white  ${homePage ? "bg-transparent text-white" : "text-royal"} ${scrolled ? " " : ""} border-gray-300 duration-300 ease-in-out`} >
