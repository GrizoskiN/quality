...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "lg:inline-flex   lg:h-10 items-center justify-between w-full m-auto rounded-md  lg:p-1 text-slate-300 dark:bg-slate-800 dark:text-slate-400",
      className
    )}
    {...props} />
))
